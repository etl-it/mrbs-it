 ...
 *********************************/
$mrbs_admin = "etl";
$mrbs_admin_email = "staff@it.uc3m.es";
...
$mrbs_company = "Dep. de Ing. Telemática";   // This line must always be uncommented ($mrbs_company is used in various places)
...
//$ldap_host = array('ldaps://repldap01.it.uc3m.es', 'ldaps://repldap01.it.uc3m.es');
$ldap_host = array('ldaps://repldap01.it.uc3m.es', 
                   'ldaps://repldap01.it.uc3m.es', 
                   'ldaps://repldap01.it.uc3m.es',
                   'ldaps://repldap01.it.uc3m.es',
                   'ldaps://repldap01.it.uc3m.es');
...
//$ldap_host = "localhost";
//$ldap_host = "repldap01.it.uc3m.es";
...
$ldap_base_dn = array('ou=miscelaneo,ou=cuentas,dc=it,dc=uc3m,dc=es',
                      'ou=profesores,ou=cuentas,dc=it,dc=uc3m,dc=es', 
                      'ou=administrativos,ou=cuentas,dc=it,dc=uc3m,dc=es', 
                      'ou=investigadores,ou=cuentas,dc=it,dc=uc3m,dc=es', 
                      'ou=tecnicos,ou=cuentas,dc=it,dc=uc3m,dc=es');
//$ldap_base_dn = array('ou=tecnicos,ou=cuentas,dc=it,dc=uc3m,dc=es', 'ou=tecnicos,ou=cuentas,dc=it,dc=uc3m,dc=es');
...
// This can be an array.
$ldap_email_attrib = 'itPersonnelMailUC3M';
